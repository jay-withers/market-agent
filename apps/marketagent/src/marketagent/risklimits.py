...
with defaults sized for the USD 100,000 paper account.
"""
...
class RiskSettings(BaseSettings):
    """Defaults sized for a USD 100,000 portfolio across a ten-name watchlist.
    ...
    being all spread; ten trades a day bounds a bad news day while still
    ...
    alone — raised from 3 to 6 after the first week's review found half the
    model's approved-confidence recommendations were being refused solely by
    this limit, then to 10.
    """
